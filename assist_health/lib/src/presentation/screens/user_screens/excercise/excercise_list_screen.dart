...
class ExerciseListScreen extends StatelessWidget {
  ...
  final List<Exercise> exercises = [
    ...
    Exercise(
        ...
        types: ['Abs2']),
    // Exercise(
    //     calories: 0.052, // Calories per second for 'Mèo lớn'
    //     name: 'Big Cat',
    //     description: 'Nằm sấp, chống tay và chân, nâng cơ thể lên cao.',
    //     duration: 30,
    //     imageUrl: 'assets/big_cats.gif',
    //     types: ['Abs1', 'Abs2']),
    // Exercise(
    //     calories: 0.060, // Calories per second for 'Xoay người hoàn toàn'
    //     name: 'Xoay người hoàn toàn',
    //     description:
    //         'Nằm nghiêng, nâng tay và chân cùng bên, giữ tư thế cân bằng.',
    //     duration: 30,
    //     imageUrl: 'assets/full_twist.gif',
    //     types: ['Abs2', 'Abs3']),
    Exercise(
