...
import 'package:assist_health/src/presentation/screens/user_screens/meals/models/meal_model.dart';
import 'package:assist_health/src/presentation/screens/user_screens/meals/views/food_recognition/food_detail_screen.dart';
...
import 'package:assist_health/src/presentation/screens/user_screens/meals/widgets/separator.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context, rootNavigator: true).push(
          MaterialPageRoute(
            builder: (context) => const FoodSuggestScreen(),
          ),
        );
      },
      child: Container(
